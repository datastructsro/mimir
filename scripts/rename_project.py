...
if __name__ == "__main__":
    # 1. Rename bundled core directory
    if os.path.exists("odoo_addon/mimir_core"):
        os.rename("odoo_addon/mimir_core", "odoo_addon/mimir_core")
        print("Renamed odoo_addon/mimir_core -> odoo_addon/mimir_core")
