...
**Mimir** is a production-grade linear regression demand forecaster designed for the [Parqcast](https://github.com/datastructsro/parqcast) ecosystem. It bridges the gap between historical data exports and automated, just-in-time inventory replenishment in Odoo.
...
3. It stores the forecast results and rules as attachments on a `mimir.run` record.
